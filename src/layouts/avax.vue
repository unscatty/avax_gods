...
const defaultDescription = 'Connect your wallet to start playing the ultimate Web3 Battle Card Game'
...
<template>
  <div class="hoc-container">
    ...
    <div class="flex flex-1">
      <img src="/resources/background/hero-img.jpg" alt="hero-img" class="w-full xl:h-full object-cover">
    </div>
  </div>
</template>
