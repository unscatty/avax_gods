...
export default defineConfig({
  shortcuts: [
    ...
    // Utils CSS shortcuts
    {
      ...
      'hoc-content-box': 'flex flex-1 justify-between bg-siteblack py-8 sm:px-12 px-8 flex-col',
      ...
      'battle-ground-card': 'sm:w-[420px] w-full h-[260px] p-2 glass-morphism m-4 rounded-lg cursor-pointer battle-card',
      'battle-ground-card-img': 'w-full h-full object-cover rounded-md',
      'battle-ground-card-text': 'font-rajdhani font-semibold text-2xl text-white',

      // Game page
      'game-container': 'w-screen min-h-screen bg-cover bg-no-repeat bg-center flex-col',
      'game-move-box': 'sm:w-20 w-14 sm:h-20 h-14 rounded-full cursor-pointer border-[2px]',
      'game-move-icon': 'w-1/2 h-1/w-1/2 object-contain',

      // player info component
      'player-img': 'w-14 h-14 object-contain rounded-full',
      'player-health': 'flex flex-row bg-white rounded-md p-2 sm:min-w-[512px] min-w-[312px] sm:min-h-[48px] min-h-[40px] bg-opacity-10 backdrop-filter backdrop-blur-lg mx-3',
      'player-health-bar': 'sm:w-4 w-2 sm:h-8 h-6 rounded-sm',
      'player-mana': 'w-14 h-14 rounded-full text-white font-rajdhani font-extrabold text-2xl cursor-pointer',
      'player-info': 'font-rajdhani font-medium',
      'player-info-span': 'font-extrabold text-white',

      // card component
      'card-container': 'relative sm:w-[260px] w-[220px] sm:h-[335px] h-[280px] z-0 transition-all',
      'card-img': 'w-full h-full object-contain',
      'card-point-container': 'absolute sm:w-[40px] w-[32px] sm:h-[40px] h-[32px] rounded-[25px] bottom-[31.4%]',
      ...
      'game-load-text': 'font-rajdhani text-siteWhite text-2xl mt-5 text-center',
      'game-load-players-box': 'flex justify-evenly items-center mt-20',
      'game-load-player-img': 'md:w-36 w-24 md:h-36 h-24 object-contain rounded-full drop-shadow-lg',
      'game-load-player-text': 'mt-3 font-rajdhani text-white md:text-xl text-base',
      'game-load-vs': 'font-rajdhani font-extrabold text-siteViolet text-7xl mx-16',

      // gameInfo component
      'game-info-icon-box': 'absolute right-2 top-1/2',
      'game-info-icon': 'bg-siteViolet w-10 h-10 rounded-md cursor-pointer',
      'game-info-icon-img': 'w-3/5 h-3/5 object-contain invert',
      'game-info-sidebar': 'absolute p-6 right-0 top-0 h-screen rounded-md flex-col transition-all ease-in duration-300',
      'game-info-sidebar-close-box': 'flex justify-end mb-8',
      'game-info-sidebar-close': 'w-10 h-10 rounded-md bg-siteViolet text-white font-rajdhani font-extrabold text-xl cursor-pointer',
      ...
      // modal
      'modal-text': 'font-rajdhani font-bold text-3xl text-white mb-6 text-center',
    }
  ],
  theme: {
    colors: {
